...
public class Tecnico extends Trabajador {
    ...
    public Tecnico(String nombre, int edad, AntiguedadEnum antiguedad, Fecha fec) {
        super(nombre, edad, antiguedad, fec);
        categoria = CategoriaEnum.CATEGORIA_TECNICO;
    }
    ...
    public double sueldoTrabajador() {
        ...
        calculoSueldo = ConstantesTrabajador.SUELDO_BASE + (ConstantesTrabajador.SUELDO_BASE * ConstantesTrabajador.IMPCAT_TECNICO) + importeAntiguedad;
